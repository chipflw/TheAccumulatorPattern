...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 39
    answer = count_cosines_from(20, 100, 0)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 2
    answer = count_cosines_from(1, 9, 0.3)
    ...
    # Test 6:
    expected = 36
    answer = count_cosines_from(1, 90, 0.29)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 1.73262  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(5, 25)
